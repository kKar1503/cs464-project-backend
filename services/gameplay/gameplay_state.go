...
// Tracks the card as selected this turn (can be deselected).
...
// Only cards selected during the current PRE_TURN can be deselected.
...
// ClearSelectedThisTurn resets the per-turn selection tracking.
